...
profile:
  ...
  more_info: >
    <p style="font-size:10px">PhD Candidate</p>
    <p style="font-size:10px">Department of Political Science</p>
    <p style="font-size:10px"><a href='https://polisci.columbia.edu/'>Columbia University</a></p>
